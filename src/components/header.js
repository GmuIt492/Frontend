...
class header extends Component {
    ...
    render() {
        let changeHeader = !this.state.pathLink.match(/[a-z]/i) ? "550px" : "300px"; //size of picture
        let changeMotto = !this.state.pathLink.match(/[a-z]/i) ? "500px" : "250px"; //location of title
        return (
